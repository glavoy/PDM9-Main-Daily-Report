...
```{r}
# This script is used to create a daily report for the AMF
# Post Distribution Monitoring at month 9
```
...
household_path <- "add path here"
pdm_data <- read_excel(data_path)
pdm_hh <- read_excel(household_path)
